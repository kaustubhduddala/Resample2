...
# Audio Separator Standalone Wrapper Script
...
# Run audio-separator using the bundled Python runtime
exec "$PYTHON_RUNTIME" "$VENV_PATH/bin/audio-separator" "$@"
