@echo off
REM Audio Separator Standalone Wrapper Script for Windows
...
REM Run audio-separator using the bundled Python runtime
"%PYTHON_RUNTIME%" "%VENV_PATH%\Scripts\audio-separator.exe" %*
